...
scatter_plot_html = "<your scatter plot HTML here>"
temp_barchart_html = "<your temperature bar chart HTML here>"
salinity_barchart_html = "<your salinity bar chart HTML here>"
